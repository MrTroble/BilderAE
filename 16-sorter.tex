...
\begin{tikzpicture}
    ...
    \inputSingle{t1_a}{a1}{($(t1_a) - (1.5, 0)$)}
    \inputSingle{t2_a}{a2}{($(a1) - (0, 0.5)$)}
    \inputSingle{t3_a}{a3}{($(a2) - (0, 0.5)$)}
    ...
    \inputSingle{l1_b}{a2n-2}{($(l1_b) - (1.5, 0)$)}
    \inputSingle{l2_b}{a2n-1}{($(a2n-2) + (0, 0.5)$)}
    \inputSingle{l3_b}{a2n}{($(a2n-1) + (0, 0.5)$)}

    \coordinate (middle) at (0, -6);
    \inputSingle{l1_a}{an}{($(middle) - (1.5, -0.2)$)}
    \inputSingle{l2_a}{an-1}{($(an) + (0, 0.5)$)}
    \inputSingle{l3_a}{an-2}{($(an-1) + (0, 0.5)$)}

    \inputSingle{t1_b}{an+1}{($(middle) - (1.5, 0.2)$)}
    \inputSingle{t2_b}{an+2}{($(an+1) - (0, 0.5)$)}
    \inputSingle{t3_b}{an+3}{($(an+2) - (0, 0.5)$)}
