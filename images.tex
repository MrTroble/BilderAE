\documentclass[tikz,border=0.1cm,convert={svg, perpage=false,command=\unexpanded{{inkscape --pdf-poppler --pages=1 -o \outfile\space --export-type="svg" \infile}}}]{standalone}
